...
import telebot, asyncio, aiohttp, json, base64, random, re, string, time, uuid
...
GITHUB_TOKEN = os.environ.get('GITHUB_TOKEN', '')  # Secure: uses environment variable
ADMIN_ID = "7074774446"
REPO_OWNER = "Shine-lay-dotcom"
REPO_NAME = "Mybot.py"
CONCURRENCY = 2000  # Set to 2000 as requested
BATCH_SIZE = 1000
# =======================================================
